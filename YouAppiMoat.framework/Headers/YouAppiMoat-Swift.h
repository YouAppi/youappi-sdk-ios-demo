...
SWIFT_MODULE_NAMESPACE_PUSH("YouAppiMoat")
...
SWIFT_PROTOCOL("_TtP11YouAppiMoat16YAAdCardDelegate_")
@protocol YAAdCardDelegate
@optional
- (void)onAdStartedWithAdUnitID:(NSString * _Nonnull)adUnitID;
- (void)onAdEndedWithAdUnitID:(NSString * _Nonnull)adUnitID;
- (void)onLoadFailureWithAdUnitID:(NSString * _Nonnull)adUnitID errorCode:(enum YAErrorCode)errorCode error:(NSError * _Nonnull)error;
- (void)onShowFailureWithAdUnitID:(NSString * _Nonnull)adUnitID errorCode:(enum YAErrorCode)errorCode error:(NSError * _Nonnull)error;
...
- (void)onCardWillLeaveApplicationWithAdUnitID:(NSString * _Nonnull)adUnitID;
- (void)onPreloadFailedWithAdUnitID:(NSString * _Nonnull)adUnitID errorCode:(enum YAErrorCode)errorCode error:(NSError * _Nonnull)error;
@end


SWIFT_CLASS("_TtC11YouAppiMoat9YAElement")
@interface YAElement : NSObject <NSCoding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end
...
@protocol YAAdVideoDelegate <YAAdCardDelegate>
@optional
...
@interface YAApiDispatcher : NSObject <NSCoding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end
...
@interface YAApiManager : NSObject <NSCoding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
@end
...
@interface YAProduct : NSObject <NSCoding, NSCopying>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
...
@interface YADownloadInfo : NSObject <NSCoding, NSCopying>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
...
@interface YADownloader : NSObject <NSCoding>
...
typedef SWIFT_ENUM(NSInteger, YAErrorCode) {
  ...
  YAErrorCodeAD_IS_ALREADY_PLAYING = 8,
...
@interface YAObjectParser : NSObject <NSXMLParserDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface YALogicManager : NSObject <CLLocationManagerDelegate, NSCoding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (void)appDidEnterBackground;
...
SWIFT_CLASS("_TtC11YouAppiMoat19YAVastConfiguration")
@interface YAVastConfiguration : YAElement <NSCopying>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)aCoder;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11YouAppiMoat18YAVastObjectParser")
@interface YAVastObjectParser : YAObjectParser
...
@interface YAVideoAdPlayerView : UIView
