...
SWIFT_CLASS("_TtC11YouAppiMoat11CloseButton")
...
SWIFT_CLASS("_TtC11YouAppiMoat15OmAdSessionUtil")
@interface OmAdSessionUtil : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11YouAppiMoat20OmViewabilityTracker")
@interface OmViewabilityTracker : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11YouAppiMoat21OmidWebViewScriptUtil")
@interface OmidWebViewScriptUtil : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)onMute;
- (CGFloat)playerVolume SWIFT_WARN_UNUSED_RESULT;
- (void)onLearnMore;
- (void)privacyButtonDidClick;
- (void)privacyViewDidClick;
...
- (void)playerItemWillResignActiveWithNotification:(NSNotification * _Nonnull)notification;
- (void)playerItemEnterBackgroundWithNotification:(NSNotification * _Nonnull)notification;
- (void)playerItemWillEnterForegroundWithNotification:(NSNotification * _Nonnull)notification;
- (void)playerItemDidBecomeActiveWithNotification:(NSNotification * _Nonnull)notification;
...
@interface YAWebViewController : UIViewController <UIGestureRecognizerDelegate, WKNavigationDelegate, WKUIDelegate>
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
@property (nonatomic, readonly) BOOL prefersStatusBarHidden;
...
+ (void)initializeWithAccessToken:(NSString * _Nonnull)accessToken userConsent:(BOOL)userConsent gdpr:(BOOL)gdpr;
+ (void)initializeWithAccessToken:(NSString * _Nonnull)accessToken consentString:(NSString * _Nonnull)consentString gdpr:(BOOL)gdpr;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
