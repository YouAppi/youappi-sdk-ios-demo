...
#import "YAMoPubInterstitialVideoAdEvent.h"
@import YouAppi;
...
@implementation YAMoPubInterstitialVideoAdEvent
{
    YAAdInterstitialVideo *interstitialVideoAd;
}
- (void)requestInterstitialWithCustomEventInfo:(NSDictionary *)info
{
    [YouAppi initializeWithAccessToken:YOUAPPI_ACCESS_TOKEN];
    interstitialVideoAd = [[YouAppi sharedInstance] interstitialVideo:@"interstitialVideoAdUnitID"];
...
- (void)showAd
{
    ...
    if (!interstitialVideoAd.isAvailable) return;
